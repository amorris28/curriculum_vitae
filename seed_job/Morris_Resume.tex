...
\cventry{2022--present}{Postdoctoral Scholar}{University of
  Oregon}{Eugene, OR}{}{
  \begin{itemize}
      \item Analyzed published data and reviewed the literature on our
          understanding of microbiome heritability in humans and animals.
      \item Submitted a first-author publication to \textit{The ISME Journal} 
...
%\subsection{Graduate School}
  ...
  Oregon}{Eugene, OR}{}{
  \begin{itemize}
      \item Analyzed microbiome metagenomic data to assemble microbial genomes
          and determine functional gene composition across a deforestation
          gradient in the Brazilian Amazon.
    \item Conducted laboratory artificial selection experiments and
        metagenome-wide association tests to identify members of the soil
          microbiome that reduce greenhouse gas emissions.
    \item Published a perspective piece on integrating quantitative genetics
        with microbiome science in \textit{Philosophical Transactions of the
          Royal Society}.
    \item Awarded multiple grants and fellowships including the prestigious
        National Science Foundation Graduate Research Fellowship and named an
          ARCS Scholar by the
          Oregon chapter of the Achievement Rewards for College Scientists Foundation. 
    \item Published a total of five peer-reviewed scientific papers.
\end{itemize}
}
...
College, PA}{}{
\begin{itemize}
  \item Demonstrated a new approach to reducing the impact of agriculture on climate change by reducing microbiome-mediated nitrous oxide emissions from soil.
  \item Conducted research with a collaborative team of over 14 scientists, farmers,
      and extension agents.
  \item Presented research results at scientific meetings including \textit{The Ecological Society of America} and the \textit{Soil Science Society of America}. 
  \item Communicated results to diverse audiences including farmers, technicians, and extension educators.
\end{itemize}
}
...
\cventry{}{Microbiome Analysis Experience}{}{}{}{
\begin{itemize}
    \item 16S rRNA gene amplicon analyses using \texttt{R}, \texttt{phyloseq}, and \texttt{QIIME2}.  
    \item Short-read shotgun metagenomic analyses including data preparation (\texttt{BBTools}), read recruitment (\texttt{bowtie2}), gene calling (\texttt{prodigal}), taxonomic and functional annotation (\texttt{Kaiju}, \texttt{KEGG}), contig assembly (\texttt{MEGAHIT}), and genome binning and comparative genomics (\texttt{Anvi'o}).
    \item Statistical analyses in \texttt{R} including linear mixed effects models with crossed, nested, and repeated measures designs as well as case-control and continuous outcomes and non-parametric tests (Kruskal-Wallis, Wilcoxon, etc.). 
    \item Microbiome analyses including ecological dissimilarity metrics (Bray-Curtis, Jaccard, UniFrac, etc.), PCoA and NMDS ordinations, PERMANOVA, Mantel tests, and differential abundance tests (\texttt{DESeq2}, \texttt{ALDEx2}, etc.).
\end{itemize}
}
\cvdoubleitem{Typesetting}{\LaTeX, \texttt{R Markdown}, \texttt{Jupyter}}{Coding}{\texttt{R},
\texttt{Bash}, \texttt{Python}}
\cvdoubleitem{Computing}{Linux, Unix, HPC, Slurm}{Collaboration}{\texttt{git}, Github,
Slack, Zoom}
...
\cvline{2021}{\textbf{Morris, AH}, Isbell, SA, Saha, D and Kaye, JP. Mitigating
  ...
  cereals. \textit{Journal of Environmental Quality}, 50(2), 324–335.

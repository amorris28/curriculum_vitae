...
%\subsection{Graduate School}
  ...
  \begin{itemize}
      \item Analyzed microbiome metagenomic data to assemble microbial genomes
          and perform comparative genomics across ecosystems.
    \item Conducted laboratory selection experiments to engineer microbiomes
        that consume greenhouse gases at high rates.
    ...
    \item Presented research to a general audience at the annual ARCS luncheon.
\end{itemize}
}
...
\begin{itemize}
  \item Demonstrated a new approach to reducing the impact of agriculture on
      climate change by reducing microbiome-mediated nitrous oxide emissions.
  \item Conducted research with a collaborative team of over 14 scientists, farmers,
      and extension agents.
  \item Presented research results at scientific meetings including \textit{The
...
\cvline{2016}{\textbf{Morris, AH}. Greenhouse gases in the Reduced-Tillage Organic Systems Experiment (ROSE). \textit{ROSE Annual Advisor Boad Meeting}. Pine Grove Mills, PA.
}

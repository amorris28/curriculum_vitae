...
\begin{bibsection}
    \item {\bf Morris, A. H.} and Bohannan, B. J. M. 2023.
        ``Response of soil microbiome composition to selection on methane oxidation rate.'' \emph{BioRxiv} %\doi{}
\end{bibsection}
...
\begin{bibsection}
    \item {\bf Morris, A. H.} and Bohannan, B. J. M.
        ``Microbiome heritability and the evolution of host-level traits.'' in prep
\end{bibsection}
%\end{comment}

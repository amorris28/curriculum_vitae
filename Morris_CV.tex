...
\begin{bibsection}
    ...
    \item {\bf Morris, A. H.}, Meyer, K. M., Bohannan, B. J. M. 2020. ``Linking microbial communities
      ...
      Royal Society B}.\\\href{https://doi.org/10.1098/rstb.2019.0244}{doi:10.1098/rstb.2019.0244}
    ...
    \item Seyfferth, A. L., {\bf Morris, A. H.}, Gill, R., Kearns, K. A., Mann,
      ...
      \href{https://doi.org/10.1021/acs.jafc.6b01201}{doi:10.1021/acs.jafc.6b01201}
\end{bibsection}
...
\begin{bibsection}
    ...
    \item Isbell, S. A., Bradley, B. A., {\bf Morris, A. H.}, Wallace, J. M.,
      Kaye, J. P. ``Nitrogen dynamics in grain cropping systems integrating
      multiple ecologically-based man-agement strategies'' \emph{Ecosphere}
    ...
    \item 
      ...
      \emph{Environment International}
...
\begin{bibsection}
    \item {\bf Morris, A. H.}, Bohannan, B. J. M. 
	    ``Artificial ecosystem selection on soil\\methane oxidation to deduce
      the mapping between microbial community\\structure and ecosystem function''
\end{bibsection}
...
\item {\bf Morris, A. H.} Greenhouse gases in the Reduced-Tillage Organic
  Systems Exper-iment (ROSE). ROSE Annual Advisory Board Meeting. Pine Grove Mills, PA. Jan. 2016
...
\section{Service}
\begin{innerlist}
\item[] Graduate student peer mentor, IE2 University of Oregon \hfill 2020-2021

...
\vspace{-.125in}
\begin{bibsection}
    \item {\bf Morris, A.H.}, Meyer, K.M., Bohannan, B.J.M. ``Linking microbial communities
    ...
    \item Meyer, K.M., Hopple, A.M., Klein, A., {\bf Morris, A.H.}, Bridgham,
      ...
      scale of function.'' \emph{Molecular Ecology}.
\end{bibsection}

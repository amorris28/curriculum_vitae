...
\begin{bibsection}
    ...
    \item 
      ...
      community structure alter methane-cycling dynamics in Amazonia'' In review at \emph{Environment International}
\end{bibsection}
...
\item[] Reviewer for Nature Ecology and Evolution, American Naturalist
\end{innerlist}

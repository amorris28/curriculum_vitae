...
\begin{bibsection}
    ...
    \item {\bf Morris, A.H.}, Akdeniz, Bayram C., Nakken, S., Shadrin, A., Seibert, T.M., Andreassen, O.A., Dale, A., Hovig, E., Frei, O.
        ``Using polygenic hazard scores to predict age at onset of prostate cancer in Nordic populations.''
\end{bibsection}
%\end{comment}
...
\section{Service}
\begin{innerlist}
\item[] Organizer of the Oslo Bioinformatics Workshop Week 2024, 2025, Oslo, Norway \hfill 2024-2025
\begin{innerlist}

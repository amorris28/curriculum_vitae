...
\textbf{Graduate Research Assistant}, University of Oregon \hfill {2017-2022}
...
%      \href{ https://doi.org/10.1002/ecs2.3380}{doi:10.1002/ecs2.3380}
    ...
    \item 
      Meyer, K.M., {\bf Morris, A.H.}, Webster, K., Klein, A., Kroegerv, M.E., 
	Meredith, L.K., Brændholt, A., Nakamurat, F., Venturini, A., Fonseca
...
%      \\\href{https://doi.org/10.1016/j.envint.2020.106131}{doi:10.1016/j.envint.2020.106131}
    ...
    \item Meyer, K.M., Hopple, A.M., Klein, A., {\bf Morris, A.H.}, Bridgham,
      ...
      function relationships in the Congo Basin methane cycle depend on the physiological
    ...
    \item Seyfferth, A.L., {\bf Morris, A.H.}, Gill, R., Kearns, K.A., Mann,
      J.N., Paukett, M., and Leskanic, C. 2016. ``Soil-incorporation of silica-rich rice husk decreases inorganic As in rice grain.''
...
\vspace{-.125in}
\begin{bibsection}
    \item {\bf Morris, A.H.}, Akdeniz, Bayram C., Nakken, S., Shadrin, A., Seibert, T.M., Andreassen, O.A., Dale, A., Hovig, E., Frei, O. 2026.
        ``Using polygenic hazard scores to predict age at onset of prostate cancer in Nordic populations.'' \emph{medRxiv}. \\\doi{10.64898/2026.01.07.26343583}
    \item Week, B., {\bf Morris, A.H.}, and Bohannan, B.J.M. 2024
        ``The Evolution of Microbiome-Mediated Traits.'' \emph{bioRxiv}. \\\doi{10.1101/2024.03.29.587374}
...
\vspace{-.125in}
\begin{bibsection}
    \item {\bf Morris, A.H.}, Akdeniz, Bayram C., Nakken, S., Shadrin, A., Seibert, T.M., Andreassen, O.A., Dale, A., Hovig, E., Frei, O.
        ``Using polygenic hazard scores to predict age at onset of prostate cancer in Nordic populations.'' in review at \emph{JCO Precision Oncology}
\end{bibsection}
% \end{comment}
...
\vspace{-.1in}
\begin{bibsection}
    \item Goleva-Fjellet, S. {\bf Morris, A.H.}, Evens, K.C., Johansen, J., Sæbø, M. Støren, Ø.
        ``Extracellular vesicle associated miRNA response to physiological testing in cross-country skiers: a cross-sectional study.''
    ...
    \item {\bf Morris, A.H.}, Meyer, K.M., Bohannan, B.J.M., et al.
        ``Identifying the metagenomic drivers of methane emissions from pastures of the brazilian amazon.''
\end{bibsection}
%\end{comment}

\section{Grants}
Contributed to NSF grant: \emph{URoL:ASC: Using Rules of Life to Capture Atmospheric Carbon: Interdisciplinary Convergence to Accelerate Research on Biological Sequestration (CARBS)} \href{https://www.nsf.gov/awardsearch/showAward?AWD_ID=2319597}{Award Number: 2319597} \hfill (\$3,000,000 USD) 2023
\begin{innerlist}
...
William R. Sistrom Memorial Scholarship\hfill (\$1000 USD) 2018
\begin{innerlist}
\item Awarded \$1000 for teaching materials for the \hyperref[teaching]{Juneau Icefield Research Program}
\end{innerlist}
\halfblankline

NSF Graduate Research Fellowship Program \\ \href{https://www.nsf.gov/awardsearch/showAward?AWD_ID=1255832}{Award Number: DGE1255832}\hfill (\$138,000 USD) 2016
\begin{innerlist}
\item Conceived of, designed, and wrote research proposal on using stable isotopes to distinguish between nitrous oxide derived from nitrification and denitrification. 
\item Five year fellowship with three years of financial support.
\end{innerlist}

\halfblankline

Hatch/Multistate Grant\hfill (\$1000 USD) 2013
\begin{innerlist}
\item Awarded \$1000 for undergraduate research on cucurbit grafting techniques.
\end{innerlist}
...
\textbf{Guest Lecturer} %\hfill {Springs 2011--12}
\begin{innerlist}
\item[] University of Oslo, Genome-Wide Association Studies: Why, How and \\ then What? \hfill 2026
\begin{innerlist}
\item Heritability Misconceptions
\end{innerlist}
\item[] University of South-Eastern Norway, EE508-1: Applied Genetics \hfill 2026
\begin{innerlist}
\item Bioinformatics
\item Microbiome Analysis with R
\end{innerlist}
\item[] University of Oregon, Bi 283H Honors Bi III: Evol, Diversity \& Ecol \hfill 2018
\begin{innerlist}
\item Evolutionary Processes
\end{innerlist}
\end{innerlist}

\textbf{Faculty} %\hfill {Springs 2011--12}
\begin{innerlist}
\item[] Juneau Icefield Research Program, Geobotany and Ecology
	\hfill 2018
\begin{innerlist}
...
\textbf{Guest Instructor} %\hfill {Springs 2011--12}
\begin{innerlist}
\item[] Penn State University, CAUSE 2017: Impacts of Changing Hydrology on Ecosystem Services in Glacial Systems \hfill 2017
\end{innerlist}

\textbf{Teaching Assistant} %\hfill {Springs 2011--12}
\begin{innerlist}
\item[] University of Oregon, Bi 283H Honors Bi III: Evol, Diversity \& Ecol
	\hfill 2018
\item[] University of Oregon, Bi 282H Honors Bi II: Gen \& Mol Bio \hfill 2018
\item[] University of Oregon, Bi 221 Principles of Biology I: Cells \hfill 2017
\item[] Penn State University, SOILS 101: Introductory Soil Science \hfill
	2017
\end{innerlist}
...
\section{Service}
\begin{innerlist}
\item[] Organizer of the Oslo Bioinformatics Workshop Week, Oslo, Norway \hfill 2024-2025
\begin{innerlist}
\item[] Technical committee - Designed and managed event website, Github repo
\item[] Program committee - Invited and selected instructors
\end{innerlist}
...
\item[] Reviewer for American Naturalist, Environmental Microbiology, FEMS Microbiology Ecology, Molecular Ecology, Nature Ecology and Evolution, Scientific Data, Scientific Reports, Environmental Microbiology Reports
\end{innerlist}
...
\item[] Aletha Anderson. (2024, April 28).
	``UO Scholar Alum Examines Biostatistics and Precision Medicine'' \emph{ARCS Foundation Oregon Chapter} \\

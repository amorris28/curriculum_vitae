...
\vspace{-.125in}
\begin{bibsection}
    \item {\bf Morris, A. H.} and Bohannan, B. J. M. 
        ``The microbiome heritability concept at age ten.'' In review at  \emph{Nature Microbiology}.
    \item {\bf Morris, A. H.} and Bohannan, B. J. M. 
        ``Response of soil microbiome composition to selection on methane oxidation rate.'' In review at  \emph{Soil Biology and Biochemistry}.
\end{bibsection}
...
\vspace{-.1in}
\begin{bibsection}
    \item Weeks, B., {\bf Morris, A. H.}, Bohannan, B. J. M.
        ``A microbiome breeders equation.''
...
\item Oregon \emph{Achievement Rewards for College Scientists} Scholar\hfill 2017
\end{innerlist}
...
\begin{innerlist}
\item {\bf Morris, A. H.} and Bohannan, B. J. M. Microbiome heritability and the evolution of host-level traits. Symbiosis Theory Workshop. Eugene, OR. 2023
\item {\bf Morris, A. H.} and Bohannan, B. J. M. Artificial ecosystem selection reveals
relationships between microbiome
composition and ecosystem function. ISME Meeting. Lausanne, Switzerland. 2022
...
\item[] Reviewer for Nature Ecology and Evolution, American Naturalist, Scientific Data, Environmental Microbiology, FEMS Microbiology Ecology
\end{innerlist}

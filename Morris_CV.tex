...
\begin{bibsection}
    \item {\bf Morris, A. H.} and Bohannan, B. J. M. 
        ``Quantitative estimates of microbiome heritability and their implications.'' \emph{Nature Microbiology}.
\end{bibsection}
...
\begin{bibsection}
    \item Akdeniz B. C., {\bf Morris, A. H.}, Møller P., Andreassen O., Hovig E., and Dominguez-Valentin M. 
        ``Risk stratification of colorectal cancer using a combined effect of polygenic risk score and mismatch repair genes for Norwegian cohort.'' in review at \emph{Tumori Journal}.
\end{bibsection}

...
\begin{itemize}
  ...
  \item Training in
    bioinformatics at the Marine Biology Laboratory in Woods Hole, MA using
        \texttt{R}, \texttt{Python}, and \texttt{QIIME2} to analyze next-generation sequencing data.  
...
\cvitem{Tools}{\texttt{R}, \texttt{Bash}, \texttt{Python}, \texttt{git}, Github, Linux, Unix, high-performance computing, cloud computing}
...
%-----       letter       ---------------------------------------------------------
% recipient data
\recipient{Dr. Yunpeng Wang and Dr. Kristine B. Walhovd}{Center for Lifespan Changes in Brain and Cognition\\University of Oslo\\Oslo, Norway}
\date{June 17, 2023}
\opening{Dear Dr. Yunpeng Wang and Dr. Kristine B. Walhovd,}
\closing{Sincerely,}
%\enclosure[Attached]{curriculum vit\ae{}}          % use an optional argument to use a string other than "Enclosure", or redefine \enclname
\makelettertitle

I am excited to apply for the Bioinformatician position
at the University of Oslo Center for Lifespan Changes in Brain and Cognition. I recently completed my PhD
in Biology at the University of Oregon and am finishing a post-doc at the
Oregon Institute of Ecology \& Evolution.
I am eager to apply my knowledge of
ecology, biodiversity, and data science to address critical issues in global
...
international collaborators. I have demonstrated success in scientific
communication through funded grant proposals, presentations at national and
international conferences, and publications in peer-reviewed scientific
journals. I also prioritize open science and reproducible research through
sharing my manuscript source files and data analysis scripts with git/Github.

In my research, I have studied biodiversity in both natural and human-managed
ecosystems including agroecosystems, tropical forests, and wetlands. My
research focuses on the impacts of human land-use change and land management on
biodiversity and the consequences for ecosystem functioning.  For example, I
have studied the impacts of reduced-tillage and organic cropping systems on
plant diversity and soil nitrogen losses. I have also studied the impacts of
rainforest-to-pasture conversion on soil biodiversity and the resultant
increases in methane emissions from soil. My work involves the integration of
multivariate data sets including species count data, taxonomic and phylogenetic
data, and ecological metadata. As part of this work, I publish biological
data in relevant repositories that use the MIxS standards, including the NCBI 
SRA and the JGI genome portal.

Going forward, I hope to build my toolset for a career in data science and to
continue to answer important biodiversity questions through this role at the
University of Oslo. I previously had an extended stay in Trondheim working with
collaborators at NTNU and I am excited to return to Norway and continue
developing my fluency in Norwegian. I believe my experience as an ecologist and
data scientist will make a valuable contribution to the research objectives of
the BioDT project.

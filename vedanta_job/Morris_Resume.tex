...
\cvdoubleitem{Typesetting}{\LaTeX, \texttt{R Markdown}, \texttt{Jupyter}}{Collaboration}{\texttt{git}, Github, Slack, Zoom}
\cvdoubleitem{Computing}{Linux, Unix, cloud computing, Slurm}{Coding}{\texttt{R},
...
function. Submitted to \textit{The ISME Journal} }
...
%-----       letter       ---------------------------------------------------------
% recipient data
\recipient{Hiring Team}{Vedanta Biosciences\\19 Blackstone Street\\Cambridge, MA 02139}
\date{February 27, 2023}
\opening{Dear Hiring Manager at Vedanta Biosciences,}
\closing{Sincerely,}
%\enclosure[Attached]{curriculum vit\ae{}}          % use an optional argument to use a string other than "Enclosure", or redefine \enclname
\makelettertitle

I am excited to apply for the Senior/Principal Research Associate, Bioinformatics
position at Vedanta Biosciences.  I recently completed my PhD in Biology at the
University of Oregon, and I am eager to apply my knowledge of the microbiome
and bioinformatics to improving human health.
...
health through this position as a Bioinformatics Research Associate. In particular, I look
...
objectives at Vedanta Biosciences.
